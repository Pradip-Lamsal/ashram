...
const getSystemFontCSS = () => {
  return `
    @import url('https://fonts.googleapis.com/css2?family=Noto+Sans+Devanagari:wght@400;500;600;700&display=swap');
    
    * {
      font-family: 'Noto Sans Devanagari', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif !important;
    }
...
export async function generatePDFWithPuppeteer(
  ...
  try {
    ...
    // Launch browser with font support
...
function generateHTMLContent(data: ReceiptData): string {
